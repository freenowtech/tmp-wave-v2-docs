...
`,sizeVariant=(0,index_esm.bU)({prop:"waveSize",variants:{small:{top:"0.875rem",padding:"0 0.125rem",fontSize:(0,themeGet.U)("fontSizes.1")},medium:{top:"1.375rem",padding:"0 0.25rem",fontSize:(0,themeGet.U)("fontSizes.2")}}}),BottomLinedInputLabel=(0,styled_components_browser_esm.ZP)(BaseInputLabel.h).attrs({theme:theme.r})`
    left: 0;
    ${sizeVariant}
`;var cssVariables=__webpack_require__("./src/utils/cssVariables.ts");const errorStyles=styled_components_browser_esm.iv`
    box-shadow: inset 0 -0.0625rem 0 0 ${(0,cssVariables.wp)("border-danger-default")};
    border-color: ${(0,cssVariables.wp)("border-danger-default")};

    & ~ ${BottomLinedInputLabel} {
        color: ${(0,cssVariables.wp)("foreground-danger-default")};
    }
`,BottomLinedInput_sizeVariant=(0,index_esm.bU)({prop:"waveSize",variants:{small:{height:"2.5rem",padding:"1rem 0.125rem 0.375rem"},medium:{height:"3.5rem",padding:"1.625rem 0.25rem 0.625rem"}}}),BottomLinedInput=(0,styled_components_browser_esm.ZP)(BaseInput.Q)`
    ${BottomLinedInput_sizeVariant}
    & ~ ${BottomLinedInputLabel} {
        ${p=>p.hasValue||p.placeholder?activeBottomLinedPosition(p.waveSize):""};
        color: ${({hasValue})=>hasValue?(0,cssVariables.wp)("foreground-neutral-emphasized"):(0,cssVariables.wp)("foreground-neutral-default")};
    ...
    &:focus:not(:disabled) {
        & ~ ${BottomLinedInputLabel} {
            ${p=>activeBottomLinedPosition(p.waveSize)};
            color: ${(0,cssVariables.wp)("foreground-focus")};
            background: ${(0,cssVariables.wp)("background-page-default")};
        }
    }
